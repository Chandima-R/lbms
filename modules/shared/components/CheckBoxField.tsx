                                ...
                                >
                                    <div className="check-box-inner">
                                        <div className="check-box-img">
                                            <img src="/media/images/checkbox.png" alt="Check box" className="check-box-box" />
                                            <img
                                                src="/media/images/check-mark.png"
                                                alt="Check mark"
                                                className={`check-box-mark ${!checkBoxValue && 'mark-hidden'}`}
                                            />
                                        </div>
